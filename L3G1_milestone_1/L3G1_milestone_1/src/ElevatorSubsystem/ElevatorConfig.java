 ...
 * and elevatorContollers the corresponding elevator to fulfill the requests.
 *
...
public class ElevatorConfig {
	...
	private static final String DROPOFF_UP = "0x32"; // going
	...
	private Elevator elevator = new Elevator("0", ElevatorButton.HOLD);
	...
	/**
	 * Function called in the main method to contoll the corresponding elevator to perform the received request.
	 */
	public void elevatorContoller() {
	...
	/**
	 * Main function of the ElevatorelevatorContoller class.
	 *
	 * @param args Command line arguments.
	 */
	public static void main(String[] args) {
		ElevatorConfig config = new ElevatorConfig();
		config.elevatorContoller();
	}//
}
